...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-screen bg-[#0a192f] text-gray-300 my-8 mb-20'>
        {/* containner */}
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8 uppercase'>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={html} alt="html icon" />
                ...
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={react} alt="react icon" />
                    <p className='my-4'>reactjs</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={nextjs} alt="nextjs icon" />
                    <p className='my-4'>nextjs</p>
                </div>
                
                
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={javascript} alt="javascript icon" />
                    <p className='my-4'>javascript</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={typescript} alt="typescript icon" />
                    <p className='my-4'>typescript</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={tailwind} alt="tailwind icon" />
                    <p className='my-6'>tailwind</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={bootstrap} alt="bootstrap icon" />
                    <p className='my-4'>bootstrap</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={python} alt="python icon" />
                ...
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={github} alt="github icon" />
                    <p className='my-4'>github</p>
                </div>
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-400'>
                    <img className='w-20 mx-auto pt-[20px]' src={firebase} alt="firebase icon" />
