  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-end items-center px-4 bg-[#0a192f] text-gray-300'>
      ...
      <ul className='md:flex'>
        ...
        <li>
          <Link  to="skills"  smooth={true}  duration={500} offset={-10}>
          Skills
        </Link>
        </li>
        <li>
        ...
        <li>
          <Link  to="activity"  smooth={true}  duration={500} offset={-100}>
          Activity
        </Link>
        </li>
        <li>
      ...
      <ul className={!nav ? 'hidden':'absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center'}>
        ...
        <li className='py-6 text-4xl'>
        <Link onClick={handleClick} to="activity"  smooth={true}  duration={500} >
          Activity
        </Link>
        </li>
        <li className='py-6 text-4xl'>
